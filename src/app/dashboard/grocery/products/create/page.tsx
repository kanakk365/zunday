        ...
        <div className="space-y-6 p-4 max-w-[1400px] mx-auto pb-20 relative">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-400 italic">Add the details about the Product to add</p>
                </div>
            </div>
            ...
            {/* Pricing & Stock */}
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8">
                <h2 className="text-base font-bold text-gray-900 mb-6">Pricing & Stock</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    <div className="space-y-2">
            ...
            {/* Product images */}
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8">
                <h2 className="text-base font-bold text-gray-900 mb-6">Product images</h2>
                ...
                >
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold text-gray-900 text-center">
                            New Product created sucessfully!!
                        </h3>
                    </div>
                </div>
            )}
