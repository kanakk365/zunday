...
export default function GroceryPayoutsPage() {
    const payouts = [
        {
            vendorName: "FreshMart Grocery",
            amount: "₹5,200",
    ...
    return (
        <div className="space-y-6 py-4">
            {/* Page Header */}
            <div>
                <h1 className="text-2xl font-bold text-gray-900">Grocery Payouts</h1>
                <p className="text-sm text-gray-400 mt-1 italic">
                    Manage all Grocery Payouts
                </p>
            </div>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {payouts.map((payout, index) => (
                                ...
                                >
                                    ...
                                    <td className="py-6 text-left text-sm text-gray-900 font-bold">
                                        {payout.amount}
                                    </td>
                                    ...
                                    <td className="py-6 pr-8 text-center">
                                        <Link href={`/dashboard/grocery/payouts/${encodeURIComponent(index.toString())}`}>
