    ...
    return (
        <div className="space-y-6 p-4 max-w-[1400px] mx-auto pb-20 relative">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Create Food Vendor</h1>
                    <p className="text-sm text-gray-400 italic">Add the details about the Food vendor to add him</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-700">Cuisine types</label>
            ...
            {/* Restaurant Details */}
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8">
                <h2 className="text-base font-bold text-gray-900 mb-6">Restaurant details</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-700">Restaurant Type</label>
                        <div className="relative">
                            <select className="w-full px-4 py-3 bg-[#f8f8ff] border-none rounded-lg text-sm text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#4B3DBF]/20 font-medium appearance-none cursor-pointer">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-700">Estimated Avg Prep Time</label>
                        <div className="relative">
                            <input
                                type="text"
                                placeholder="Choose Time"
                ...
                <div className="space-y-2 mt-6">
                    <label className="text-xs font-bold text-gray-700">Restaurant Address</label>
                    <textarea
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    <div className="border border-dashed border-[#4B3DBF]/40 rounded-lg p-8 flex flex-col items-center justify-center gap-3 cursor-pointer hover:bg-gray-50 transition-colors bg-[#FAFAFF]">
                    ...
                    <div className="border border-dashed border-[#4B3DBF]/40 rounded-lg p-8 flex flex-col items-center justify-center gap-3 cursor-pointer hover:bg-gray-50 transition-colors bg-[#FAFAFF]">
                        <CloudUpload size={32} className="text-gray-900" />
                        <div className="text-center">
                            <p className="text-sm font-medium text-gray-900">FSSAI License</p>
                            <p className="text-xs font-bold text-[#4B3DBF] mt-1">Browse Files</p>
                        </div>
                    </div>
                    <div className="border border-dashed border-[#4B3DBF]/40 rounded-lg p-8 flex flex-col items-center justify-center gap-3 cursor-pointer hover:bg-gray-50 transition-colors bg-[#FAFAFF]">
                ...
                >
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold text-gray-900 text-center">
                            New Food Vendor created sucessfully!!
                        </h3>
                    </div>
                </div>
            )}
